# Simple ride-sharing System using class building and class based fucntion building using givin ULM tables, and test code (as definded at the end of the program)
...
class Car:
    ...
    def move_to(self, new_x, new_y):
        self.new_x = new_x
        self.new_y = new_y
        self.location = Location(self.new_x, self.new_y)
